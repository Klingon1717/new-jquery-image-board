...
$(document).ready(function () {
	...
	$.get('http://tiyfe.herokuapp.com/deathtoselfie', function (response) {
	...
	$.post('http://tiyfe.herokuapp.com/deathtoselfie', {
		...
		$display.prepend('<div class = "photoBox"><div><img class = "newPhoto"s src= ' + response.photo + '></img></div><div class ="newCap"> ' + response.caption + '</div></div>');
	}, 'json');
